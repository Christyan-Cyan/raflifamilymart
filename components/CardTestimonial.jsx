  ...
  return (
    <>
      <div className="bg-[#161A22] rounded-2xl p-8">
        <p className="text-justify">Belanja kebutuhan di Rafli.FamilyMart benar-benar memudahkan saya untuk memenuhi kebutuhan keluarga.
        ...
        <div className="flex flex-row mt-6">
          <Image
            ...
            className="max-w-12"
          />
          <h1 className="text-medium text-lg ml-4 my-auto">Budiono siregar</h1>
